...
func TestDiff(t *testing.T) {
	...
	specs := []Spec{
		...
		{
			Before: "create table fuga (id integer not null AUTO_INCREMENT, a varchar(10), b bigint, c decimal, e tinyint not null default 0, f datetime, primary key(id));",
			After:  "CREATE TABLE `fuga` (\n`id` int(11) NOT NULL AUTO_INCREMENT,\n`a` varchar(10) DEFAULT NULL,\n`b` bigint(20) DEFAULT NULL,\n`c` decimal(10,0) DEFAULT NULL,\n`e` tinyint(4) NOT NULL DEFAULT '0',\n`f` datetime DEFAULT NULL,\nPRIMARY KEY (`id`)\n);",
			Expect: "",
		},
	}
